...
6. 发版您的版本
    ...
    git tag  -a v1.5.1 -m "[已有 Mirror酱 CDK？点击前往高速下载](https://mirrorchyan.com/zh/projects?rid=Maa_MHXY_MG)"
    ...
    git -c http.sslVerify=false push origin v1.5.1
